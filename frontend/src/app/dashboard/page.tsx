          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="glass p-6 rounded-2xl relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-sm font-medium text-white/60 uppercase tracking-wider">Active Agents</h3>
                  <Users className="w-5 h-5 text-green-400/60" />
                </div>
                <p className="text-4xl font-heading font-bold text-green-400">{data.active_agents}</p>
              </div>
              ...
              <div className="glass p-6 rounded-2xl relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-sm font-medium text-white/60 uppercase tracking-wider">System Status</h3>
                  <CheckCircle className="w-5 h-5 text-blue-400/60" />
                </div>
                <p className="text-4xl font-heading font-bold text-blue-400">{data.system_status}</p>
              </div>
            </div>
